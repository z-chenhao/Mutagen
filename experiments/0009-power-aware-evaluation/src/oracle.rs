//! The deterministic external-state task oracle (Experiment 0009).
//!
...
//! trajectory tags, cost, or the model's final-answer wording. Nor can
//! it see the stress level or the difficulty-selection decision (spec
//! §14): the oracle judges the *outcome*, not how it was produced.
//!
...
/// A task split. Development tasks feed the family-level difficulty
/// calibration (Phase A); held-out tasks feed the experiment verdict
/// (Phase B).
