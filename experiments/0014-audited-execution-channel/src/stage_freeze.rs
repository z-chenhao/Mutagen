//! The commit-level stage-artifact freeze system (Experiment 0014).
//!
...
//! would have applied).
//!
//! 0014 therefore freezes every completed stage at the Git level:
//!
