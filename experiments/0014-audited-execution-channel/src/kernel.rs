...
//!
//! Experiment 0014: the hard limits (`max_model_turns`,
...
//!
//! 0014 deadline contract (the experiment's only semantic delta, spec
...
//!
//! Experiment 0014 (deadline-safe semantics): the kernel OWNS the
...
/// episode-deadline constant exists anywhere else — 0014 rule).
...
fn empty_request(turn: u32) -> ModelRequestRecord {
    ModelRequestRecord {
        ...
        // The audited-channel binding (0014) is stamped from the
...
// Deadline-aware model call protocol (0014, spec §21/§22): the
...
///
/// 0014: the boundary also returns the audited-channel binding
...
mod tests {
    ...
    // --- 0014 deadline-semantics kernel tests (network-free) --------
