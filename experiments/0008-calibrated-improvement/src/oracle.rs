//! The deterministic external-state task oracle (Experiment 0008).
//!
...
/// A task split (spec §23). Calibration tasks feed difficulty
/// selection; held-out tasks feed the experiment verdict.
