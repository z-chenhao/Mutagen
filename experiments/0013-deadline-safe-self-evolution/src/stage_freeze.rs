//! The commit-level stage-artifact freeze system (Experiment 0013).
//!
...
//! would have applied).
//!
//! 0013 therefore freezes every completed stage at the Git level:
//!
