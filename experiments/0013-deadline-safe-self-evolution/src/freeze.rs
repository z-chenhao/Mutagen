//! The mechanical source-freeze system (Experiment 0013, carried
//! forward in mechanism from Experiment 0011).
//!
//! This is one of the two decisive 0013 mechanisms (together with the
...
//! committed mid-selection). 0011 (and now 0013) enforces the freeze
//! mechanically:
//!
...
pub const FROZEN_PATHS: &[&str] = &[
    "experiments/0013-deadline-safe-self-evolution/Cargo.toml",
    "experiments/0013-deadline-safe-self-evolution/Cargo.lock",
    "experiments/0013-deadline-safe-self-evolution/design.json",
    "experiments/0013-deadline-safe-self-evolution/tasks.json",
    "experiments/0013-deadline-safe-self-evolution/stress-profile.json",
    "experiments/0013-deadline-safe-self-evolution/prompts/incumbent.md",
    "experiments/0013-deadline-safe-self-evolution/prompts/mutator.md",
    "experiments/0013-deadline-safe-self-evolution/src/main.rs",
    "experiments/0013-deadline-safe-self-evolution/src/protocol.rs",
    "experiments/0013-deadline-safe-self-evolution/src/model.rs",
    "experiments/0013-deadline-safe-self-evolution/src/kernel.rs",
    "experiments/0013-deadline-safe-self-evolution/src/tools.rs",
    "experiments/0013-deadline-safe-self-evolution/src/oracle.rs",
    "experiments/0013-deadline-safe-self-evolution/src/mutation.rs",
    "experiments/0013-deadline-safe-self-evolution/src/selection.rs",
    "experiments/0013-deadline-safe-self-evolution/src/stats.rs",
    "experiments/0013-deadline-safe-self-evolution/src/freeze.rs",
    "experiments/0013-deadline-safe-self-evolution/src/stage_freeze.rs",
    "experiments/0013-deadline-safe-self-evolution/src/trace.rs",
    "experiments/0013-deadline-safe-self-evolution/src/experiment.rs",
    "docs/experiments/0013-deadline-safe-self-evolution.md",
];
...
pub fn crate_dir() -> PathBuf {
    std::env::var("CARGO_MANIFEST_DIR")
        .map(PathBuf::from)
        .unwrap_or_else(|_| PathBuf::from("experiments/0013-deadline-safe-self-evolution"))
}
