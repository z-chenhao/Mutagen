...
//! `parallel_tool_calls = false`). One provider exists for this
...
//! async runtime. The only network I/O performed by the whole
//! experiment process is this HTTP request.
//!
//! Experiment 0011 addition: temperatures are *parameters* supplied by
//! the caller from the design manifest — this module holds no
//! temperature constants of its own.
