//! The commit-level stage-artifact freeze system (Experiment 0012).
//!
...
//! would have applied).
//!
//! 0012 therefore freezes every completed stage at the Git level:
//!
