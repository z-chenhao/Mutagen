//! The mechanical source-freeze system (Experiment 0012, carried
//! forward in mechanism from Experiment 0011).
//!
//! This is one of the two decisive 0012 mechanisms (together with the
...
//! committed mid-selection). 0011 (and now 0012) enforces the freeze
//! mechanically:
//!
...
///
/// Exactly 21 files. The results document is NOT frozen.
pub const FROZEN_PATHS: &[&str] = &[
    "experiments/0012-frozen-self-evolution-confirmation/Cargo.toml",
    "experiments/0012-frozen-self-evolution-confirmation/Cargo.lock",
    "experiments/0012-frozen-self-evolution-confirmation/design.json",
    "experiments/0012-frozen-self-evolution-confirmation/tasks.json",
    "experiments/0012-frozen-self-evolution-confirmation/stress-profile.json",
    "experiments/0012-frozen-self-evolution-confirmation/prompts/incumbent.md",
    "experiments/0012-frozen-self-evolution-confirmation/prompts/mutator.md",
    "experiments/0012-frozen-self-evolution-confirmation/src/main.rs",
    "experiments/0012-frozen-self-evolution-confirmation/src/protocol.rs",
    "experiments/0012-frozen-self-evolution-confirmation/src/model.rs",
    "experiments/0012-frozen-self-evolution-confirmation/src/kernel.rs",
    "experiments/0012-frozen-self-evolution-confirmation/src/tools.rs",
    "experiments/0012-frozen-self-evolution-confirmation/src/oracle.rs",
    "experiments/0012-frozen-self-evolution-confirmation/src/mutation.rs",
    "experiments/0012-frozen-self-evolution-confirmation/src/selection.rs",
    "experiments/0012-frozen-self-evolution-confirmation/src/stats.rs",
    "experiments/0012-frozen-self-evolution-confirmation/src/freeze.rs",
    "experiments/0012-frozen-self-evolution-confirmation/src/stage_freeze.rs",
    "experiments/0012-frozen-self-evolution-confirmation/src/trace.rs",
    "experiments/0012-frozen-self-evolution-confirmation/src/experiment.rs",
    "docs/experiments/0012-frozen-self-evolution-confirmation.md",
];
...
pub fn crate_dir() -> PathBuf {
    std::env::var("CARGO_MANIFEST_DIR")
        .map(PathBuf::from)
        .unwrap_or_else(|_| PathBuf::from("experiments/0012-frozen-self-evolution-confirmation"))
}
