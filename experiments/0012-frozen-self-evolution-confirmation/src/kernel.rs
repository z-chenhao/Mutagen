...
//!
//! Experiment 0012: the hard limits (`max_model_turns`,
...
use crate::trace::{
    ExecutedToolCall, ModelRequestRecord, RequestedToolCall, TerminationReason, Timing,
};
...
/// `max_model_turns` / `max_tool_calls`); there is no second source of
/// truth in this crate.
