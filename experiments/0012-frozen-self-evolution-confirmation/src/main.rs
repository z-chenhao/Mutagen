//! Experiment 0012 runner: Frozen End-to-End Self-Evolution
...
//!
//! Endpoint discipline (0012 formal protocol condition): these four
...
//! Raw trajectories/summaries: docs/experiments/artifacts/0012-*.
//!
...
fn usage() {
    println!(
        "mutagen-exp-0012 — Frozen End-to-End Self-Evolution Confirmation\n\
         \n\
         ...
         binary (the 0011 `run --task` smoke command does not exist in 0012);\n\
    ...
    let result = match command.as_str() {
        ...
        "print-a0" => {
            experiment::print_a0_commands(
                "exp: preregister frozen 0012 self-evolution confirmation",
            );
            Ok(())
        }
        ...
        _ => {
            ...
            eprintln!("run: cargo run -p mutagen-exp-0012 -- help");
