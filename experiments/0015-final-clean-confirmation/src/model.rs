...
//! audited channel GATEWAY (Experiment 0015).
//!
//! Carried over from Experiments 0006/0010/0011/0013, with the 0015
...
//! runtime.
//!
//! 0015 deadline contract: this client defines NO episode-deadline or
...
//! command does not exist in 0015).
//!
//! Timeout classification (0015 §20): ureq 2.x surfaces transport
...
/// The ONE registered experiment endpoint for this experiment (0015):
...
pub const REGISTERED_ENDPOINT: &str = "http://127.0.0.1:18150/v1";

/// One authorized channel request (0015): the four registered headers
...
/// Structured transport-timeout classification (0015 §20).
///
