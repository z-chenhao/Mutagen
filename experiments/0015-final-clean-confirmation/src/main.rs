//! Experiment 0015 runner: Frozen End-to-End Self-Evolution
...
//!
//! Endpoint discipline (0015 formal protocol condition): these four
...
//! Raw trajectories/summaries: docs/experiments/artifacts/0015-*.
//!
...
pub fn registered_commands() -> Vec<(&'static str, bool)> {
    vec![
        ("self-test", false),
        // 0015 audited-execution-channel commands (all local; the
...
fn usage() {
    println!(
        "mutagen-exp-0015 — Frozen End-to-End Self-Evolution Confirmation\n\
         \n\
         ...
         binary (the 0011 `run --task` smoke command does not exist in 0015);\n\
    ...
    let result = match command.as_str() {
        ...
        "print-a0" => {
            experiment::print_a0_commands(
                "exp: preregister final clean 0015 self-evolution confirmation",
            );
            Ok(())
        }
        ...
        _ => {
            ...
            eprintln!("run: cargo run -p mutagen-exp-0015 -- help");
