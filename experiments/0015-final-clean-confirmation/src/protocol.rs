//! OpenAI-compatible Chat Completions protocol surface for Experiment 0015.
//!
...
/// are present (the 0015 frozen agent request semantics, spec §10); the
...
impl ChatRequest {
    ...
    /// The exact serialized request body bytes (0015 audited channel:
