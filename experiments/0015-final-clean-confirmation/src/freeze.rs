//! The mechanical source-freeze system (Experiment 0015, carried
...
//! committed mid-selection). 0011 (and now 0015) enforces the freeze
//! mechanically:
//!
...
pub const FROZEN_PATHS: &[&str] = &[
    "experiments/0015-final-clean-confirmation/Cargo.toml",
    "experiments/0015-final-clean-confirmation/Cargo.lock",
    "experiments/0015-final-clean-confirmation/design.json",
    "experiments/0015-final-clean-confirmation/tasks.json",
    "experiments/0015-final-clean-confirmation/stress-profile.json",
    "experiments/0015-final-clean-confirmation/prompts/incumbent.md",
    "experiments/0015-final-clean-confirmation/prompts/mutator.md",
    "experiments/0015-final-clean-confirmation/src/main.rs",
    "experiments/0015-final-clean-confirmation/src/channel.rs",
    "experiments/0015-final-clean-confirmation/src/channel_ledger.rs",
    "experiments/0015-final-clean-confirmation/src/protocol.rs",
    "experiments/0015-final-clean-confirmation/src/model.rs",
    "experiments/0015-final-clean-confirmation/src/kernel.rs",
    "experiments/0015-final-clean-confirmation/src/tools.rs",
    "experiments/0015-final-clean-confirmation/src/oracle.rs",
    "experiments/0015-final-clean-confirmation/src/mutation.rs",
    "experiments/0015-final-clean-confirmation/src/selection.rs",
    "experiments/0015-final-clean-confirmation/src/stats.rs",
    "experiments/0015-final-clean-confirmation/src/freeze.rs",
    "experiments/0015-final-clean-confirmation/src/stage_freeze.rs",
    "experiments/0015-final-clean-confirmation/src/trace.rs",
    "experiments/0015-final-clean-confirmation/src/experiment.rs",
    "docs/experiments/0015-final-clean-confirmation.md",
];
...
/// identity (0015). Once committed, it is the authority every live
...
pub fn crate_dir() -> PathBuf {
    std::env::var("CARGO_MANIFEST_DIR")
        .map(PathBuf::from)
        .unwrap_or_else(|_| PathBuf::from("experiments/0015-final-clean-confirmation"))
}
